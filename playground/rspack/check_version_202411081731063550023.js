...
const CheckVersion = /** @class */ (function () {
  ...
  CheckVersion.prototype.check = function () {
    return __awaiter(this, arguments, void 0, function (bool) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            this.current_version = sessionStorage.getItem(this.version_key) || void 0
            return [4 /* yield */, fetch(`./version?key=${Date.now()}`)]
          case 1:
            data = _b.sent()
            _a = this
          ...
          case 2:
            ...
            console.log('version_value', this.version_value)
            console.log('current_version', this.current_version)
  ...
  CheckVersion.prototype.hideDialog = function () {
    const _this = this
  ...
  CheckVersion.prototype.refreshVersion = function () {
    this.hideDialog()
    localStorage.setItem(this.version_key, this.version_value)
    window.location.reload()
  }
  CheckVersion.prototype.startCheck = function () {
    const _this = this
...
window.onload = function () { const check = new CheckVersion({ time: 30000, systemName: 'system' }); check.startCheck() }
